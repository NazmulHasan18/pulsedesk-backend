...
const createCompanySchema = z.object({
  body: z.object({
    name: z.string({ error: 'Company name is required' }).min(2, 'Company name must be at least 2 characters'),
...
const updateCompanySettingsSchema = z.object({
  body: z.object({
    settings: z.object({}).passthrough().refine((value) => Object.keys(value).length > 0, {
